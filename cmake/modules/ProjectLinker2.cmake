...
function(LinkProjects Requirement include_var imported_libs_list )
    ...
    foreach( ProjectToLink ${ARGN} )
        ...
        if( ${ProjectToLinkUpper}_FOUND )
            ...
            list( APPEND include_var ${${ProjectToLinkUpper}_INCLUDES} )
            ...
            list( APPEND imported_libs_list ${ProjectToLinkUpper}_LIB_VAR )
        else()
...
function(LinkStaticProjects Requirement include_var static_libs_list )
    ...
    foreach( StaticProjectToLink ${ARGN} )
        ...
        if( ${StaticProjectToLinkUpper}_FOUND )
            list( APPEND include_var ${${StaticProjectToLinkUpper}_INCLUDES} )
            list( APPEND static_libs_list ${${StaticProjectToLinkUpper}_LIB} )
        else()
